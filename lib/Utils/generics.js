...
const baileys_version_json_1 = require("../Defaults/kurtucoben-baileys-version.json");
const Types_1 = require("../Types");
const WABinary_1 = require("../WABinary");
const baileysVersion = baileys_version_json_1.version
const PLATFORM_MAP = {
    'aix': 'AIX',
    'darwin': 'Mac OS',
    'win32': 'Windows',
...
const generateMessageID = () => 'KURTU-COBEN-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
